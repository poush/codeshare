...
<head>
    <meta charset="UTF-8">
    <title>Server Requirements &dash; Codlax</title>
...
<body>
    <div class="wrapper">
        ...
        <h1>Codlax - Server Requirements.</h1>
        ...
        if($requirements['php_version'] && $requirements['mcrypt_enabled'])
            echo '<a type="button" class="btn btn-success btn-lg" href="step2.php?update=0">Continue To Second Step</a>or<a class="btn btn-danger btn-lg" href="step2.php?update=1">Upgrade to 1.4 </a>';
        else
            echo '<a type="button" class="btn btn-danger btn-block btn-lg" disabled=""> Sorry Your Server does not meet requirments</a>';
        ?>
    </div>
</body>
</html>